...
// safety bounds
if (state.biodiesel > 65) state.biodiesel = 65;
if (state.biodiesel < 35) state.biodiesel = 35;
...
/* -----------------------------
   MAIN ACTION (FIXED + BIO INTEGRATION)
------------------------------*/
...
// 🟡 update biodiesel layer AFTER risk
